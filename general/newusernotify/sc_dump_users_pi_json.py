...
from SCICOMP.dbo.PS_FH_STAFF
where (((JOB_FUNCTION = 'FAC' and PAYGROUP = 'FHC') or JOBTITLE = 'Full Member') and EMPL_STATUS <> 'T' and JOBTITLE <> 'Dir, UW-Alvord Brain Tumor Ctr' and JOBTITLE <> 'Practicing Phys- Neurosurgery')
